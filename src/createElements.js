...
function createEl() {
    ...
    function projectsSelector(arr) {
        ...
        projects.forEach((li) =>
            selectOption(li.children[0].textContent, input)
        );
    ...
    function simpleElement(type, selector_name, innerContent) {
    ...
    function popEl(name) {
        ...
        const popup = simpleElement("div", "pop-up-" + name);
        const popup_content = simpleElement("div", "pop-up-content-" + name);
