...
function askUserName() {
    ...
    function popupName() {
        ...
        const btnConfirm = create.btnCreator(allElements, "Confirm");
...
function btn_Container(btnAddName) {
    const btnContainer = create.simpleElement("div", "btn-container");
    const btnClose = create.btnCreator([], "Close");
    const btnAdd = create.btnCreator([], btnAddName);
